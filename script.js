...
function startTypewriter() {
    ...
    */
    const message = "My Dear Honeyy,<br><br>" +
                    ...
                    "I Missed You Alottt telsaa.. How can i not You are my other half and nothing in this world is perfect without its other half right.. only you make me complete and a whole person honeyyy and im sooo luckyyyy to have you in my life.I Love You sooo muchh honeyy if one day the universe asks me what do you want ill chose you in every universe honeyy. i want to spend happily rest of my life with you honeyy.ik we havent spent much time together this year but those very moments im there beside you, are more precious to me than any diamond to me.. every second i spent with you im longing for those every moments again and again you are my happines bangaram my love my wifeee ill work hard and ill take you with me bangaram i wish u will be happy all the time and me being beside you all the time honeyy 'Nanu ninnannu pritisuttene' 'nanu unnai kaadhalikeren manivi' uk i never felt special abt learning different languages until u said its great honeyy wanting me to learn more so i can express my love to u in all the languages hehe.<br><br>" +
                    "once again wishing you and our family a very very happy new year honeyy ❤️, wishing everything will go good and u will be happy all the time.stay safe stay happy keep smiling honeyy i lovee you soo muchh";
...
function initMatrix() {
    ...
    function draw() {
        ...
        for (let i = 0; i < drops.length; i++) {
            const text = "HAPPYNEWYEAR2026LOVE❤️✨"[Math.floor(Math.random()*23)];
